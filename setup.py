...
setup(
    ...
    author='Equipo Empathy',
    author_email='empathy@team.dev',
    url='https://github.com/empathy-team/empathy-analyzer',
    ...
    project_urls={
        'Bug Reports': 'https://github.com/empathy-team/empathy-analyzer/issues',
        'Documentation': 'https://empathy-analyzer.readthedocs.io/',
        'Source': 'https://github.com/empathy-team/empathy-analyzer',
    },
    zip_safe=False,
)